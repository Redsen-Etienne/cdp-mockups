...
/* ── COMPTES RENDUS ──────────────────────────────────────────────────────────
   Champs :
     ...
     date             : date et auteur affichés (ex: '15 Mai 2026 - Thomas Girard')
...
var COMPTES_RENDUS = [
    ...
    { id:'CR-00001', clientId:'CT-0001', date:'02 Juin 2026 - Thomas Girard',       titre:'Visite chantier Résidence Les Fontaines',      corps:'Avancement conforme au planning. Robert Garnier satisfait de la réactivité sur les livraisons béton. Discussion sur l\'extension possible pour le second bâtiment. Devis complémentaire à préparer avant le 15/06.' },
    { id:'CR-00002', clientId:'CT-0001', date:'14 Avril 2026 - Thomas Girard',      titre:'Point commercial T1 2026',                     corps:'CA en progression de 10,5% vs N-1. Validation du plan de développement sur la gamme revêtement. Client souhaite un accès prioritaire aux nouveautés Parex. RDV showroom prévu en mai.' },
    { id:'CR-00003', clientId:'CT-0001', date:'18 Mars 2026 - Thomas Girard',       titre:'Visite bureau client',                         corps:'Point bilan T1. Robert Garnier signale un besoin urgent en produits de coffrage pour l\'École Jean Moulin. Commande passée sur place. Discussion stock dédié envisagée pour les références courantes.' },
    { id:'CR-00004', clientId:'CT-0001', date:'05 Février 2026 - Thomas Girard',    titre:'Appel téléphonique — suivi devis',              corps:'Relance devis coffrage D-2026-034 (8 400 €). Client confirme bon de commande en cours de validation. Livraison souhaitée semaine 8. Logistique à caler avec le dépôt de Vénissieux.' },
    { id:'CR-00005', clientId:'CT-0001', date:'20 Novembre 2025 - Thomas Girard',   titre:'Visite chantier Entrepôt Logistique Corbas',   corps:'Premier passage sur le futur chantier. Surface estimée 4 200 m². Besoins : dalle béton, cloisons, étanchéité toiture. CA potentiel estimé 35 k€. Appel d\'offre prévu en janvier 2026.' },
    { id:'CR-00006', clientId:'CT-0001', date:'08 Octobre 2025 - Thomas Girard',    titre:'Visite bureau — plan d\'action S2',            corps:'Présentation catalogue automne-hiver 2025. Intérêt fort pour la gamme ITE. Client demande une formation technique pour ses équipes. Date à caler avec le service formation Raboni.' },
    { id:'CR-00007', clientId:'CT-0001', date:'03 Juillet 2025 - Thomas Girard',    titre:'Déjeuner commercial mi-année',                 corps:'Revue de mi-année. Objectif CA atteint à 94%. Cause : retard chantier École Jean Moulin (+6 sem). Plan de rattrapage S2 validé. Relation commerciale solide, aucun risque de perte client.' },

    /* ── CT-0002 : Dupont Construction — Lucas Reynaud ── */
    { id:'CR-00008', clientId:'CT-0002', date:'12 Avril 2026 - Lucas Reynaud',      titre:'Visite bureau client',                         corps:'Discussion baisse CA vs N-1 (-12%). Alain Dupont signale un report de chantiers sur T2. Potentiel de rattrapage estimé 40 k€ sur S2. Action : proposition d\'offre groupée plâtrerie + ciment avec remise volume.' },
    { id:'CR-00009', clientId:'CT-0002', date:'20 Janvier 2026 - Lucas Reynaud',    titre:'Point compte début d\'année',                  corps:'Présentation catalogue 2026. Intérêt pour les nouvelles références BA18 et BA25 phoniques. Commande test : 200 plaques BA18. Livraison semaine 5 confirmée.' },
    { id:'CR-00010', clientId:'CT-0002', date:'28 Novembre 2025 - Lucas Reynaud',   titre:'Visite chantier Copropriété Montchat',         corps:'Chantier bien avancé, Sylvie Moreau satisfaite. Besoin en enduit de finition pour les parties communes (estimé 3 k€). Devis envoyé le soir même. Concurrence Pointp mentionnée sur les enduits.' },
    { id:'CR-00011', clientId:'CT-0002', date:'15 Septembre 2025 - Lucas Reynaud',  titre:'Appel téléphonique — relance devis',           corps:'Relance devis D-2025-789 (malaxeurs + outillage, 6 400 €). Patrice Lebrun confirme validation en cours. Bon de commande attendu sous 48h. Livraison à coordonner avec le chantier Gerland.' },
    { id:'CR-00012', clientId:'CT-0002', date:'04 Juillet 2025 - Lucas Reynaud',    titre:'Déjeuner commercial mi-année',                 corps:'CA S1 à 56% de l\'objectif annuel. Alain Dupont souhaite renégocier les conditions tarifaires sur le ciment. Demande transmise au responsable commercial. Accord cadre à revoir en septembre.' },
    { id:'CR-00013', clientId:'CT-0002', date:'12 Mars 2025 - Lucas Reynaud',       titre:'Visite bureau — lancement plan 2025',          corps:'Objectif fixé à 130 k€ (+1,5% vs N). Focus : développement isolation et outillage. Client valide le principe d\'un stock tampon dédié. Mise en place prévue avril 2025.' },

    /* ── CT-0003 : Maçonnerie Martin — Sarah Lefèvre ── */
    { id:'CR-00014', clientId:'CT-0003', date:'28 Mars 2026 - Sarah Lefèvre',       titre:'Visite chantier Rénovation Villa Couzon',      corps:'Franck Martin autonome et efficace. Intérêt marqué pour le carrelage format XXL 120x120. Devis D-2026-112 envoyé (7 200 €). Discussion sur un accord-cadre 2026 pour gagner du temps sur les commandes récurrentes.' },
    { id:'CR-00015', clientId:'CT-0003', date:'10 Février 2026 - Sarah Lefèvre',    titre:'Point commercial — suivi devis',               corps:'Relance devis carrelage XXL. Franck confirme validation pour la Villa Couzon. Nouvelle opportunité : extension maison à Bron (dalle + carrelage, estimé 5 k€). Visite à planifier.' },
    { id:'CR-00016', clientId:'CT-0003', date:'09 Janvier 2026 - Sarah Lefèvre',    titre:'Appel téléphonique — bilan 2025',              corps:'CA 2025 en hausse de 9% vs 2024. Franck satisfait du service, apprécie la réactivité. Objectif 2026 fixé à 85 k€. Nouvel axe : développer la gamme colle et joint haut de gamme.' },
    { id:'CR-00017', clientId:'CT-0003', date:'18 Novembre 2025 - Sarah Lefèvre',   titre:'Visite chantier Extension Maison Bron',        corps:'Chantier terminé dans les délais, client très content. Franck recommande Raboni à ses confrères. Opportunité de prescription : 3 artisans de son réseau pourraient devenir clients.' },
    { id:'CR-00018', clientId:'CT-0003', date:'07 Août 2025 - Sarah Lefèvre',       titre:'Visite bureau — présentation gamme automne',   corps:'Présentation nouveautés carrelage automne 2025 (grès cérame effet bois, grands formats). Franck commande 4 échantillons. Intérêt pour les joints époxy Mapei. Commande test prévue en septembre.' },
    { id:'CR-00019', clientId:'CT-0003', date:'03 Avril 2025 - Sarah Lefèvre',      titre:'Point commercial T1 2025',                    corps:'CA T1 conforme (+8%). Forte demande clients sur les carrelages grande taille. Stock tampon proposé pour les références phares. Accord de principe, mise en place prévue mai 2025.' },

    /* ── CT-0004 : Artisan Carrelage Plus — Julie Marchand ── */
    { id:'CR-00020', clientId:'CT-0004', date:'05 Mai 2026 - Julie Marchand',       titre:'Visite comptoir + échange commercial',         corps:'Rencontre lors d\'un passage comptoir. Baisse CA depuis janvier (-18%). Concurrence Leroy Merlin sur le petit matériel. Proposition : carte fidélité pro + remise volume sur commandes > 1 500 €. Réponse attendue sous 15 jours.' },
    { id:'CR-00021', clientId:'CT-0004', date:'28 Avril 2026 - Julie Marchand',     titre:'Appel téléphonique — offre fidélité',          corps:'Présentation de l\'offre fidélité. Client réceptif. Demande devis comparatif sur carreaux 60x60. Devis D-2026-089 envoyé dans la journée (2 800 €). Décision attendue avant fin mai.' },
    { id:'CR-00022', clientId:'CT-0004', date:'14 Mars 2026 - Julie Marchand',      titre:'Visite bureau client',                         corps:'Premier RDV bureau depuis 6 mois. CA en recul, pression concurrentielle confirmée. Intérêt pour les formations pose grands formats organisées par Raboni. Inscription proposée pour juin 2026.' },
    { id:'CR-00023', clientId:'CT-0004', date:'20 Novembre 2025 - Julie Marchand',  titre:'Visite chantier maison individuelle',          corps:'Bonne qualité de pose. Client utilise exclusivement les références Porcelanosa achetées chez Raboni. Opportunité : le promoteur cherche un fournisseur pour 8 autres maisons. À qualifier.' },
    { id:'CR-00024', clientId:'CT-0004', date:'02 Septembre 2025 - Julie Marchand', titre:'Point commercial rentrée',                     corps:'Objectif CA 2025 : 45 k€. Plusieurs chantiers en vue sur T4. Commande prévisionnelle estimée 12 k€. Gamme colle flex Mapei à mettre en avant. Catalogue laissé sur place.' },
    { id:'CR-00025', clientId:'CT-0004', date:'04 Février 2025 - Julie Marchand',   titre:'Visite bureau — plan d\'action 2025',          corps:'CA 2024 : 38 200 €. Objectif 2025 : 42 k€. Client souhaite la livraison express 24h sur les références phares. Demande transmise à la logistique.' },

    /* ── CT-0005 : Aprobatec — Thomas Girard ── */
    { id:'CR-00026', clientId:'CT-0005', date:'19 Mai 2026 - Thomas Girard',        titre:'Visite chantier Bureaux Confluence',           corps:'Avancement à 60%. Client satisfait des panneaux isolants Isover. Nouvelle commande à venir pour la phase 2 (plafonds, estimé 6 k€). Devis à envoyer avant le 25/05.' },
    { id:'CR-00027', clientId:'CT-0005', date:'07 Avril 2026 - Thomas Girard',      titre:'Point commercial — suivi plan développement',  corps:'CA T1 en hausse de 45% vs N-1. Passage en catégorie A validé. Conditions spéciales isolation haute performance accordées à partir du 01/05. Client très engagé dans la relation commerciale.' },
    { id:'CR-00028', clientId:'CT-0005', date:'18 Mars 2026 - Thomas Girard',       titre:'Présentation gamme isolation haute performance', corps:'Présentation technique avec l\'appui du technicien Isover. Retour très positif sur les solutions ITE. Commande d\'un chantier test : 80 m² de façade. Mise en œuvre prévue en avril.' },
    { id:'CR-00029', clientId:'CT-0005', date:'22 Octobre 2025 - Thomas Girard',    titre:'Visite showroom — Journées portes ouvertes',   corps:'Présence du client et de son associé. Fort intérêt pour les solutions acoustiques et isolants biosourcés. Devis demandé sur spot pour un chantier tertiaire Lyon 2ème. Envoyé le 24/10.' },
    { id:'CR-00030', clientId:'CT-0005', date:'02 Septembre 2025 - Thomas Girard',  titre:'Visite bureau — découverte et qualification',  corps:'Premier RDV physique. Entreprise en forte croissance (+30% CA). Besoins clairs : isolation thermique, phonique et fire safe. Accord pour un devis cadre annuel. Très bon potentiel.' },

    /* ── CT-0006 : Entreprise Bâtiment Pro — Thomas Girard ── */
    { id:'CR-00031', clientId:'CT-0006', date:'28 Mai 2026 - Thomas Girard',        titre:'Visite chantier Centre Commercial Val-de-Marne', corps:'Chantier 12 000 m². Visite avec Marie Leblanc. Livraisons béton et cloisons conformes. Besoin supplémentaire : faux-plafonds galerie marchande (estimé 22 k€). Devis prioritaire demandé avant fin juin.' },
    { id:'CR-00032', clientId:'CT-0006', date:'10 Avril 2026 - Thomas Girard',      titre:'Point commercial T1 2026',                     corps:'CA T1 à 87 k€, +3% vs N-1. Marie Leblanc signale un ralentissement possible au T2. Trois projets en négociation finale (estimé total 180 k€). Suivi hebdomadaire maintenu.' },
    { id:'CR-00033', clientId:'CT-0006', date:'02 Février 2026 - Thomas Girard',    titre:'Revue de compte annuelle',                     corps:'Bilan 2025 : CA 312 k€, +8% vs 2024. Parmi les 5 premiers comptes de l\'agence. Plan 2026 : objectif 340 k€. Axe prioritaire : étanchéité et couverture sur les nouveaux chantiers.' },
    { id:'CR-00034', clientId:'CT-0006', date:'28 Novembre 2025 - Thomas Girard',   titre:'Présentation nouveaux partenaires fournisseurs', corps:'Présentation des accords Raboni avec Saint-Gobain et Knauf. Marie Leblanc intéressée par le placo haute performance. Commande pilote 500 plaques BA25 Fire validée sur place.' },
    { id:'CR-00035', clientId:'CT-0006', date:'10 Septembre 2025 - Thomas Girard',  titre:'Appel téléphonique — suivi satisfaction',      corps:'Suivi post-livraison chantier Immeuble Pasteur. Retour très positif. Opportunité signalée : futur chantier bureau à Créteil début 2026 (estimé 45 k€). À suivre.' },
    { id:'CR-00036', clientId:'CT-0006', date:'15 Mars 2025 - Thomas Girard',       titre:'Déjeuner d\'affaires — présentation nouveautés', corps:'Présentation catalogue 2025 et des solutions digitales (portail commande en ligne). Direction enthousiaste. Engagement à tester le portail sur 3 mois. Formation utilisateurs à organiser.' },
    { id:'CR-00037', clientId:'CT-0006', date:'08 Janvier 2025 - Thomas Girard',    titre:'Visite bureau — plan d\'action 2025',          corps:'CA 2024 : 289 k€. Objectif 2025 : 315 k€. Nouveaux axes : isolation et étanchéité, amélioration délais livraison hors-stock. Plan de formation technique à prévoir sur T2.' }
];
